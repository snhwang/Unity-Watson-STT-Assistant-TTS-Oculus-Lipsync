...
namespace IBM.Cloud.SDK
{
    ...
    public class LogRecord
    {
        ...
        /// <summary>
        /// Returns a <see cref="System.String"/> that represents the current <see cref="IBM.Cloud.SDK.Logging.LogRecord"/>.
        /// </summary>
        /// <returns>A <see cref="System.String"/> that represents the current <see cref="IBM.Cloud.SDK.Logging.LogRecord"/>.</returns>
